...
CREATE TABLE IF NOT EXISTS character_descriptors_pool_modifiers (
    id VARCHAR(36) PRIMARY KEY DEFAULT(UUID()),
...
CREATE TABLE IF NOT EXISTS character_descriptors_trainings (
    id VARCHAR(36) PRIMARY KEY DEFAULT(UUID()),
    descriptor_id VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS character_descriptors_inabilities (
    id VARCHAR(36) PRIMARY KEY DEFAULT(UUID()),
    descriptor_id VARCHAR(36) NOT NULL,
    skill_id VARCHAR(36) NOT NULL,
    FOREIGN KEY (descriptor_id) REFERENCES character_descriptors (id) ON DELETE CASCADE,

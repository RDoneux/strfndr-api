...
VALUES 
    ...
    (
        (SELECT id FROM items WHERE name = 'Detonation (Singularity)'),
        '10',
    ...
    (
        (SELECT id FROM items WHERE name = 'Detonation (Sonic)'),
        '1d6 + 2',
        'Explodes with terrifying sound, deafening all in an immediate radius.'
    ),
    (
        (SELECT id FROM items WHERE name = 'Detonation (Spawn)'),
        '1d6 + 2',
    ...
    (
        (SELECT id FROM items WHERE name = 'Detonation (Web)'),
        '1d6 + 2',
    ...
    (
        (SELECT id FROM items WHERE name = 'Disrupting Nodule'),
        '1d6',
    ...
    (
        (SELECT id FROM items WHERE name = 'Force Cube Projector'),
        '1d6 + 3',
    ...
    (
        (SELECT id FROM items WHERE name = 'Force Nodule'),
        '1d6',
    ...
    (
        (SELECT id FROM items WHERE name = 'Friction-Reducing Gel'),
        '1d6',
    ...
    (
        (SELECT id FROM items WHERE name = 'Frigid Wall Projector'),
        '1d6 + 2',
    ...
    (
        (SELECT id FROM items WHERE name = 'Gas Bomb'),
        '1d6 + 2',
    ...
    (
        (SELECT id FROM items WHERE name = 'Gravity Nullifier'),
        '1d6 + 3',
    ...
    (
        (SELECT id FROM items WHERE name = 'Gravity-Nullifying Spray'),
        '1d6 + 2',
    ...
    (
        (SELECT id FROM items WHERE name = 'Heat Nodule'),
        '1d6',
    ...
    (
        (SELECT id FROM items WHERE name = 'Hunter/Seeker'),
        '1d6',
    ...
    (
        (SELECT id FROM items WHERE name = 'Image Projector'),
        '1d6',
    ...
    (
        (SELECT id FROM items WHERE name = 'Inferno Wall Projector'),
        '1d6 + 2',
    ...
    (
        (SELECT id FROM items WHERE name = 'Infiltrator'),
        '1d6',
    ...
    (
        (SELECT id FROM items WHERE name = 'Instant Servant'),
        '1d6',
    ...
    (
        (SELECT id FROM items WHERE name = 'Intant Shelter'),
        '1d6 + 3',
    ...
    (
        (SELECT id FROM items WHERE name = 'Lightning Wall Projector'),
        '1d6 + 2',
    ...
    (
        (SELECT id FROM items WHERE name = 'Living Solvent'),
        '1d10',
    ...
    (
        (SELECT id FROM items WHERE name = 'Machine Control Implant'),
        '1d6 + 2',
    ...
    (
        (SELECT id FROM items WHERE name = 'Magnetic Attack Drill'),
        '1d6 + 2',
